...
└────────────┬──────────────────────────────────────────┬─────────────┘
         ...
         └───┬────────┘                        └────────┬───┘
             ...
             └─────────────────────┬───────────────────┘
              ...
              │                  │                  │                 │
         ┌────▼─────┐     ┌─────▼──┐         ┌────▼───┐        ┌────▼────┐
         │ PostgreSQL│     │ Redis  │         │Local SMTP│      │pgAdmin  │
...
| **Email** | Local SMTP (MailHog optional) | Latest | Local email testing (run MailHog separately or point to SMTP provider) |
...
2. **Email Notifications** (local test server → production)
   ```typescript
   // Replace local test SMTP (e.g., MailHog) with SendGrid or Mailgun
